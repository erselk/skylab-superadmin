        ...
        { key: 'rolesString', header: 'Roller' },
        {
          ...
          render: (_value, row) => (
            <div className="flex items-center gap-3">
              <Link href={`/users/${row.id}`} className="text-dark hover:text-brand underline cursor-pointer">
                Düzenle
              </Link>
              <button onClick={() => handleDelete(row)} className="text-dark-600 hover:text-dark-700 underline cursor-pointer">
                Sil
              </button>
            </div>
          ),
